...
version = th.text.find(r"version\s*=", version_path, -1, 0, False, True)[0]
...
completed_process = th.call.shell(f"pdoc ./qrotor/ -o ./docs --mermaid --math --footer-text='QRotor {version} documentation'", cwd)
